...
class Pinball {
  ...
  query(options) {
    ...
    const aLLIndexes = this._getBucketIndexes({ longitude: options.lowerLongitude, latitude: options.lowerLatitude });
    const aURIndexes = this._getBucketIndexes({ longitude: options.upperLongitude, latitude: options.upperLatitude });
    let aResults  = [];
    let aArraySet = [];
    // ilongitude loop
