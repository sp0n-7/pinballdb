  ...
  _addToArray(options) {
    ...
    if (aArray.length > 0) {
      ...
      if (val >= lastValue) {
        ...
        console.warn({ action: 'pinballdb._addToArray.out.of.order.err', id: id, val: val, lastValue: lastValue });
        // aArray.push({ id: id, val: val });
        ...
        console.warn({ action: 'pinballdb._addToArray.out.of.order.err', id: id, val: val, lastValue: lastValue, spliceComplete: Date.now()-t0 });
      }
    }
    else {
      aArray.push({ id: id, val: val });
